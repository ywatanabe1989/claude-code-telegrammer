"""Sphinx configuration for claude-code-telegrammer documentation."""
...
project = "claude-code-telegrammer"
...
try:
    ...
    release = _get_version("claude-code-telegrammer")
except Exception:
    release = "0.0.0"
...
html_context = {
    ...
    "github_repo": "claude-code-telegrammer",
    "github_version": "main",
